...
| [[T-243]] | `UserForm` kapsam seçicisi — dört kapıya uyum, `R-1` pair semantiği **yapısal** olarak korundu (`useFieldArray` satır listesi). ⛔ Kalıcı regresyon testi `qa-engineer`'a (`§3`) | **P1** | frontend-engineer | review |
