...
| [[T-242]] | Kapsam **GÜNCELLEME** yolu — `T-241`'den ayrıldı: *yaratma bayrağı açar, güncelleme bir yönetim yeteneği*. ⚠️ Rol değişiminde kapsam ne olur sorusu `T-235 ADIM 3`'te zorunlu hâle gelir | P2 | architect | todo |
