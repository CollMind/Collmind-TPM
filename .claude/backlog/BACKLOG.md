...
| [[T-252]] | ⚡ **YENİDEN AÇILDI** — `RolesGuard` kontrolü ekleniyor: `@Roles` var ama guard zincirde yoksa **metadata hiç okunmaz** → ratchet yeşil, RBAC uygulanmıyor. `T-250`'nin *üçüncü kanal* vakasının aynısı. İhlal → **`exit 2`**, kova değil | **P1** | qa-engineer | in-progress |
