...
| [[T-266]] | **KAPSAM RATCHET'i** — üç karar verildi, bölünmüş kapsamla açıldı: **`A1=67` · `A2=27`**. Taban `money-float-domain-a.txt` + gerekçeli üç ekleme. ⛔ `A1`'in en üstü: `shared/budget` **YAZMA** uçları (kapsam atfı `0`, ve bütçe yazıyorlar) | **P1** | qa-engineer | in-progress |
