...
| [[T-282]] | **`CLAUDE.md` envanteri** — desen anlatan kaç kural **mevcut bir aracı** adlandırmıyor? `Z34`'ün genel formu: araç vardı, kural işaret etmiyordu. Refleks-açığı sınıfını **kökten** kapatır. ⚠️ Aciliyeti yok | P3 | architect | todo |
