...
| [[T-287]] | ⛔ **CANLI KUSUR** — iki ekranda rol-kapısı ile rota-kümesi ayrışıyor → kullanıcı `403` görüyor. ⚠️ **Karar gelmeden düzeltme YAPILMAZ** (ürün sahibi); kaza-dalgasına bağlı | **P1** | frontend-engineer | todo |
