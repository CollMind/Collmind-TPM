...
| [[T-290]] | ⚠️ **TEKRARLADI** (2 bağımsız tur) — `app-runtime-grants` self-test case 15 **ARALIKLI** düşüyor — runner altında `1/3`, tek başına `2/2` yeşil. Geçici dizin çakışması değil (`mktemp -d`). ⚠️ Aralıklı bir self-test, guard'ı aralıklı olarak **güvenilmez** yapar | P2 | debugger | todo |
