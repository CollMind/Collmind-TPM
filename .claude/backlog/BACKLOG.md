...
| [[T-245]] | ✅ KAPANDI — `B1` olarak `T-242a`'da canlı çıktı. `UNIQUE` **NULL'ları ayırt etmiyordu** (ölçüldü: `(user,cpl,NULL)`×2 → ihlal yok) → migration **`1810`** `NULLS NOT DISTINCT` + dedupe kapısı `400` | P2 | backend-engineer | done |
