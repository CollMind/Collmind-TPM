...
| [[T-291]] | `lta-calculation.service` — **SESSİZ SIFIR** finansal hesap yolunda (`§2.5`). Eksik fiyat `0` GSV üretiyor ⇒ LTA harcaması **olduğundan küçük** görünür. `W4b`'nin *"hesap-okuma"* diye kutsadığı üç rotanın hesabı | **P1** | backend-engineer | todo |
