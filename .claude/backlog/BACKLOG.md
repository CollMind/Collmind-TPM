...
| [[T-270]] | 🔴 **Canlı bütçe doğrulaması ÖLÜ modeli okuyor** — `budget_allocations` `0` satır, `budget_envelopes` `4`; `GET /spend-calculation/validate-budget/:planId` her planda *"yetersiz bütçe"* diyor. ⛔ `T-265`'te controller **tümüyle silinmemeli** — `POST` ucu tablonun tek yazma yolu ve bir e2e onu çağırıyor | **P0** | architect | todo |
