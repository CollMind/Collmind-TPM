...
| [[T-266]] | ⛔ **BLOKE — ölçüm yapıldı, `DUR` tetiklendi.** `235` rota sınıflandı: `C 103` · `B 38` · **`A 94` (%40)** → beklenti tablosunun **DEVASA** dalı, ratchet bir **borç defteri** olurdu. ~`75` YENİ boşluk; `shared/budget`'ın **yazma uçları dâhil** tamamı kapsamsız | **P1** | qa-engineer | blocked |
