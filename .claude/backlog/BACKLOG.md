...
| [[T-241]] | 🔴 **`user_scopes`'a YAZMA YOLU YOK** — HTTP ucu `0`, `POST /users` kapsam yazmıyor; tek yollar seed + tek-seferlik backfill. Migration `1792` *"admin manuel eklemeli"* diyor, **o yol da yok**. ⚡ Bayrağı BLOKLUYOR | **P1** | backend-engineer | todo |
