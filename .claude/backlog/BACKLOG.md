...
| [[T-200]] | `ADR 0012`'nin 4. adımı **inmedi** — şema guard'ı yok, `INV-L-001` hâlâ `HOLDS` | **P1** | backend-engineer | todo |
| [[T-201]] | 🔴 Soft-delete yolu **yok**, ve `v_budget_summary`'de yön ADR'nin korktuğunun **tersi** | **P1** | architect | todo |
