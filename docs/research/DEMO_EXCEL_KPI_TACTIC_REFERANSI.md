...
1. **NIV grubu** (ve Turnover/Gross Margin grupları) Excel'de var, BRD-42'de görünmüyor — düşüş **bilinçli miydi?** NIV off-invoice hesabının tabanı: yoksa canlı motor off-invoice'u neye dayandırıyor?
   **ARA-BULGU [2026-08-29, Fable ölçümü]:** Kaynak-zincir netleşti — KPI-Library PDF'leri + BRD A1-promptu 11 grup / 52 kalem içeriyor ve **NIV(3)+Turnover(4)+GM(3) orada VAR**; Section_05-42'si tam bu üç grubun (=10 kalem) eksiği. Yapısal kanıt: 42'nin kendi LTA-formülleri NIV'e, ROI&RAG'ı iTO/iGP'ye bağımlı — düşüş derleme kaybı, tasarım kararı değil. **Hüküm-önerisi:** eşleme-evreni 52'ye revize; Section_05'e F12-düzeltme (K-2.2.8c-emsali) W2'de; canlı-motor off-invoice-tabanı kod-ölçümü W2'nin ilk maddesi.
