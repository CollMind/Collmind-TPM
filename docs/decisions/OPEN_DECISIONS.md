...
| `0067-LUMPSUM` | Lumpsum dağıtım tabanı **base** mi **planned** hacim mi — ve `null base` SKU pay alır mı? | `0067 §1-2` · [[T-194]] · `ADR 0006` (öncülü yanlışlandı) | yeni ürün lansmanlarında SKU kârlılığı · bütçe rezervasyonu | **açık** ⛔ **üç sinyal**: `§5.2` metni *planned* · `§5.2` örneği *ikisi de değil* · `ADR 0006` + `0001` *base* |
